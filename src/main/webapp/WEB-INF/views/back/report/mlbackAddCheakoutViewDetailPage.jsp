...
<body class="c-app">
	...
	<div class="c-wrapper">
		<div class="c-body">
			<div class="c-main">
				<div class="c-init">
					<div class="c-option">
						<span class="c-option-title">Checkout</span>
						<div class="group">
	...
	<script>
		...
		function getChecoutsData(callback) {
			...
			$.ajax({
				url: "${APP_PATH}/MlbackAddCheakoutViewDetail/getAddCheakoutViewUrlCountList",
				type: "post",
				data: JSON.stringify({
					'addcheakoutviewdetailCreatetime': startTime,
					'addcheakoutviewdetailMotifytime': endTime
				}),
				dataType: "json",
				...
				error: function (err) {
					toastr.error('Failed to get checkout-data, please refresh the page to get again！');
				},
				complete: function () {
					$('.c-mask').hide();
				}
