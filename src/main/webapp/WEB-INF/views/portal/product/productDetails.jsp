			...
			<div class="product-header">
				...
				<div class="product-details">
					...
					<div class="product-pay paypal-button-container">
						...
						<div title="paypal" class="btn paypal-button paypal-button-paypal">
