  ...
  <body>
    ...
    <script>
		...
		card.on("ready", function (event) {
		  document.querySelector('.card-element-box').classList.remove('mask');
		});
		...
		var loading = function(isLoading) {
		  if (isLoading) {
		    ...
		    document.querySelector("#payment-form .btn-text").classList.add("hidden");
		  } else {
		    document.querySelector("#payment-form").disabled = false;
		    document.querySelector("#payment-form .spinner").classList.add("hidden");
		    document.querySelector("#payment-form .btn-text").classList.remove("hidden");
		  }
		};
    </script>  
  </body>
