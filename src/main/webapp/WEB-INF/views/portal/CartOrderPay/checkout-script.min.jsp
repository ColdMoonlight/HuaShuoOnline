...
<!-- paypal button -->
<script>function addPaypalScript(){var a=document.createElement("script");a.src="https://www.paypal.com/sdk/js?client-id="+ml.paypal_clientid+"&components=messages,buttons",document.body.appendChild(a),a.onload=function(){paypalPayment()},a.onerror=function(){mlModalTip("paypal loading failed, Please refresh the page later and try again...")}}function checkInputAdressInfoForPaypalButton(){for(var a=!0,e=0,n=$(".address-box .form-group").length;e<n;e+=1){var o=$(".address-box .form-group")[e];if(!$(o).find(".form-control").data("status")&&(!$(o).find(".form-control").val()||"state"==$(o).find(".form-control").val())){a=!1;break}}return a}function paySuccessfulLoading(){var a=parseInt($(".modal").css("z-index"),10)+$(".modal").length+1||99999999999,e=$('<div class="pay-loading" style="z-index: '+a+'"><div style="width:100%;height:100%;background-repeat:no-repeat;background-position:center;background-image:url(${APP_PATH}/static/pc/img/paypal-success.gif)"></div></div>');$(document.body).append(e),addFixed()}function paypalPayment(){paypal.Buttons({env:"production",style:{layout:"vertical",color:"gold",shape:"rect",size:"medium",label:"paypal"},commit:!0,onInit:function(a,e){checkInputAdressInfoForPaypalButton()?e.enable():e.disable(),$(".paypal-loading").addClass("hide"),$(".address-box .form-group input").on("change",function(){checkInputAdressInfoForPaypalButton()?e.enable():e.disable()})},onClick:function(a,e){if(checkInputAdressInfo()){var n=getOrderAddress();payLoading(),$.ajax({url:"${APP_PATH}/MlfrontAddress/save",type:"post",dataType:"json",data:JSON.stringify(n),contentType:"application/json",success:function(a){if(100==a.code){var e=a.extend.mlfrontAddress,n=$(".order-list").data("productidarr")?$(".order-list").data("productidarr").split(","):[],o=$(".order-cal-subtotal").data("price");$("#addressId").val(e.addressId),fbq("track","AddPaymentInfo",{content_ids:n,content_type:"product",value:o,currency:"USD"})}else hidePayLoading(),sysModalTip()},error:function(){hidePayLoading(),sysModalTip()}})}},createOrder:function(){var a,e=getOrderPayInfo();return $.ajax({url:"${APP_PATH}/MlfrontOrderSuper/orderToPayInfo",data:JSON.stringify(e),type:"post",dataType:"json",contentType:"application/json",async:!1,success:function(e){if(100==e.code){var n=JSON.parse(e.extend.data);n.links&&n.links.forEach(function(e){"approval_url"==e.rel&&(a=e.href.match(/EC-\w+/)[0])})}if(200==e.code){hidePayLoading();createModal({header:{html:"<p>Paypal Error tip!</p>"},body:{html:"<p>"+e.extend.data+"</p>"}})}},error:function(a){sysModalTip()},complete:function(){hidePayLoading()}}),a},onApprove:function(a){payLoading(),$.ajax({url:"${APP_PATH}/paypal/msuccess?paymentId="+a.paymentID+"&PayerID="+a.payerID,success:function(a){paySuccessfulLoading(),setTimeout(function(){window.location.href="${APP_PATH}/success.html"},1e3)},error:function(){mlModalTip("Payment failed, please try again later!")}})},onCancel:function(){hidePayLoading()},onError:function(){hidePayLoading(),mlModalTip("Payment failed, please try again later!")}}).render("#paypal-button-container-2")}addPaypalScript();</script>