...
<script>$(".website-policy-item").on("click",function(e){$(this);var t,a='<iframe src="'+e.target.href+'"><iframe>';e.preventDefault(),t=createModal({header:{html:"<p>"+$(this).data("title")+"</p>"},body:{html:a}}),t.addClass("policy-modal")});</script>
