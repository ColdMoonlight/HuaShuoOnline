...
public class MlbackActShowPro {
    ...
    private Integer actshowproActnum;

    private Integer actshowproProid;

    private String actshowproProname;

    private String actshowproSeoname;

    private Integer actshowproCateid;

    private String actshowproCatename;

    private String actshowproCateseoname;

    private String actshowproPageseoname;

    private Integer actshowproIfproorcate;

    private String actshowproImgwapurl;

    private String actshowproImgpcurl;

    private Integer actshowproStatus;

    private Integer actshowproOrderth;

    private String actshowproCreatetime;

    private String actshowproMotifytime;
	...
	public String toString() {
		return "MlbackActShowPro [actshowproId=" + actshowproId + ", actshowproName=" + actshowproName
				...
				+ ", actshowproCateseoname=" + actshowproCateseoname + ", actshowproPageseoname="
				+ actshowproPageseoname + ", actshowproIfproorcate=" + actshowproIfproorcate + ", actshowproImgwapurl="
				+ actshowproImgwapurl + ", actshowproImgpcurl=" + actshowproImgpcurl + ", actshowproStatus="
				+ actshowproStatus + ", actshowproOrderth=" + actshowproOrderth + ", actshowproCreatetime="
				+ actshowproCreatetime + ", actshowproMotifytime=" + actshowproMotifytime + "]";
	}
