...
//		ecppOrder.setShipping_id(1);//发货方式	参见字典查询接口 name为shipping
		...
		Integer EcppSalesAccountId = (Integer) PropertiesUtil.getProperty("megalook.properties", "EcppSalesAccountId");
		System.out.println("EcppSalesAccountId:"+EcppSalesAccountId);
		ecppOrder.setSales_account_id(EcppSalesAccountId);//(30Magalook mall/32Magalook test )		渠道账号	参见渠道账号查询列表
